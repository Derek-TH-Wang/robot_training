...
from robot_training.robot_envs.fetch import fetch_env
...
class FetchTestEnv(fetch_env.FetchEnv, utils.EzPickle):
    def __init__(self):
        ...
        rospy.logwarn("go into FetchTestEnv")
        ...
        LoadYamlFileParamsTest(rospackage_name="robot_training",
                               rel_path_from_package_to_file="scripts/robot_training/task_envs/fetch/config",
